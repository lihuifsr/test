...
public class ImageFilter {
	...
	@Test
	public void crateImageTest() throws IOException {}
	
	public static void main(String[] args) throws IOException {
		
		for (int i = 0; i < 2; i++) {
			File file = new File("D:\\image4\\"+i+".tiff");
			
			BufferedImage image = ImageIO.read(file);
			
			ImageFilter imageFilter = new ImageFilter(image);
			
//			image = imageFilter.changeGrey();// 图像二值化
//			imageFilter.image = image;
			
//			image = imageFilter.sharp();//锐化
//			imageFilter.image = image;
			
//			image = imageFilter.median();//中值滤波
//			imageFilter.image = image;
			
//			image = imageFilter.lineGrey();//线性灰度变换 
//			imageFilter.image = image;
			
			image = imageFilter.grayFilter();//转换为黑白灰度图
			imageFilter.image = image;
...
//			image = imageFilter.scaling(5D);//平滑缩放
			
			File newfile = new File( "D:\\image4\\newimage"+i+".tif");
